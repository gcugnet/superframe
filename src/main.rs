// superframe - A frame which is really cool, enhancing colored paintings
// through many LEDs controlled with love.
// Copyright (C) 2021 Guillaume Cugnet <guillaume.cugnet@gmail.com>
//
